        ...
        <div className="pt-36 md:pt-40 md:pb-20">
          ...
          <div className="relative max-w-xl mx-auto md:max-w-none text-center md:text-left">
            ...
            <div className="md:w-[600px]">
              ...
              Prove your ownership, secure your {' '}
              ...
              <p className="text-lg text-blue-200 mb-8" data-aos="fade-up" data-aos-delay="200">
                Transform your physical assets into a digital Proof of Asset and 
                <br className="hidden md:block" /> start accessing new opportunities with what you already own.
              </p>
            ...
            <div className="max-w-sm mx-auto md:max-w-none md:absolute md:left-[600px] md:top-0 -mb-12 md:-mt-12 md:mb-0">
              <div className="relative -ml-3 -mr-24 md:mx-0">
                <img
                  ...
                  aria-hidden="true"
                />
                <img src={HeroImage} className="md:max-w-none" width="548" height="545" alt="Credit card" data-aos="fade-up" />
              </div>
            </div>
          </div>
        </div>
