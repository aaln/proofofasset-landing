        ...
        <div className="py-12 md:py-28 md:pb-20">
          ...
          <div className="max-w-sm mx-auto grid gap-12 md:grid-cols-3 md:-mx-9 md:gap-0 items-start md:max-w-none">
            ...
            >
              ...
              <h4 className="text-xl font-bold mb-1">Send Assets to our Vault</h4>
              <p className="text-slate-500">
              Receive an insured shipping label with detailed packing and shipping instructions.
              </p>
            </div>
            ...
            >
              ...
              <h4 className="text-xl font-bold mb-1">Authenticated & Vaulted</h4>
              <p className="text-slate-500">
              Our experts manually authenticate each asset to guarantee authenticity.
              </p>
            </div>
            ...
            >
              ...
              <h4 className="text-xl font-bold mb-1">Proof of Asset NFT</h4>
              <p className="text-slate-500">
              Receive your Proof of Asset NFT and enjoy what's yours, knowing your asset is always safe, secured, and accessible.
              </p>
            </div>
          </div>
        </div>
